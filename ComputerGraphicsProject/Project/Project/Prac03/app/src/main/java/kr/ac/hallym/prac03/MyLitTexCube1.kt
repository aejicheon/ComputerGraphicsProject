...
class MyLitTexCube1(myContext: Context) {
    ...
    private val vertexCoords = FloatArray(108).apply {
        val vertex = arrayOf(
            floatArrayOf(-3.0f, 3.0f, -3.0f),
            floatArrayOf(-3.0f, 0.0f, -3.0f),
            floatArrayOf(3.0f, 0.0f, -3.0f),
            floatArrayOf(3.0f, 3.0f, -3.0f),
            floatArrayOf(-3.0f, 3.0f, 3.0f),
            floatArrayOf(-3.0f, 0.0f, 3.0f),
    ...
    init {
        val vertexShader:Int = loadShader(GLES30.GL_VERTEX_SHADER, "cube1_light_tex_vert.glsl", myContext)
        val fragmentShader: Int = loadShader(GLES30.GL_FRAGMENT_SHADER, "cube1_light_tex_frag.glsl", myContext)
        ...
        GLUtils.texImage2D(GLES30.GL_TEXTURE_2D, 0, loadBitmap("win.bmp", myContext),0)
